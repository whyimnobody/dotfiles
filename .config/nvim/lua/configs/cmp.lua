...
cmp.setup({
	...
	mapping = {
		...
		["<Tab>"] = cmp.mapping.confirm({ select = true }), -- Turn on autocomplete on <C-y>
		...
		["<C-Tab>"] = cmp.mapping(cmp.mapping.select_prev_item(), { "i", "c" }),
		["<C-S-Tab>"] = cmp.mapping(cmp.mapping.select_next_item(), { "i", "c" }),
	},
